...
typedef SptiteHandle_t						(*pfnEngSrc_pfnSPR_Load_t )			( const char *szPicName );
typedef int							(*pfnEngSrc_pfnSPR_Frames_t )			( SptiteHandle_t hPic );
typedef int							(*pfnEngSrc_pfnSPR_Height_t )			( SptiteHandle_t hPic, int frame );
typedef int							(*pfnEngSrc_pfnSPR_Width_t )			( SptiteHandle_t hPic, int frame );
typedef void						(*pfnEngSrc_pfnSPR_Set_t )				( SptiteHandle_t hPic, int r, int g, int b );
...
typedef void						(*pfnEngSrc_pfnSetCrosshair_t )		( SptiteHandle_t hspr, wrect_t rc, int r, int g, int b );
...
typedef const struct model_s *		(*pfnEngSrc_GetSpritePointer_t )		( SptiteHandle_t hSprite );
...
typedef void	(*pfnEngDst_pfnSPR_Frames_t )			( SptiteHandle_t * );
typedef void	(*pfnEngDst_pfnSPR_Height_t )			( SptiteHandle_t *, int * );
typedef void	(*pfnEngDst_pfnSPR_Width_t )			( SptiteHandle_t *, int * );
typedef void	(*pfnEngDst_pfnSPR_Set_t )				( SptiteHandle_t *, int *, int *, int * );
...
typedef void	(*pfnEngDst_pfnSetCrosshair_t )			( SptiteHandle_t *, struct rect_s *, int *, int *, int * );
...
typedef void	(*pfnEngDst_GetSpritePointer_t )		( SptiteHandle_t * );
